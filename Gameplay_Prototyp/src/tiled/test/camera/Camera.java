...
public class Camera {
   ...
   /** the array of layers, which will be drawn */
   protected Integer[] visibleLayers;
    ...
    */
   public Camera(GameContainer gc, TiledMap map, Integer[] layers) {
      this.map = map;
   ...
   public void drawMap(int offsetX, int offsetY) {
       ...
       for (Integer layerIndex : visibleLayers)
       {
       map.render(   
             tileOffsetX + offsetX,
             tileOffsetY + offsetY,
